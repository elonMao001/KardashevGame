...
public class PlanetEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        base.OnInspectorGUI();
        if (GUILayout.Button("Test Face Generation")) {
            planetGenerator.TestFaceGeneration();
        }
        if (GUILayout.Button("Test SubChunk Generation")) {
            planetGenerator.TestSubChunkGeneration();
        }
