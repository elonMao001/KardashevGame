...
namespace PlanetGeneration_OLD.SphereGenerators {

	public struct GeoIcosphere : ISphereGenerator {
		...
		public void Execute<S> (int i, S streams) where S : struct, ISphereStreams {
			int u = i / 5;
